...
- Add the required dependencies for WorkManager library
...
- User presses a button -> custom broadcast -> logged to file -> notification shown
- Emulator simulates low battery -> system broadcast -> logged -> notification shown
- WorkManager wakes -> counts recent events -> summary notification shown
- UI reads log file -> displays all past events
